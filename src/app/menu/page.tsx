...
export default function MenuPage() {
    ...
    return (
        <div style={{ paddingTop: '72px', minHeight: '100vh', background: 'var(--dark-roast)' }}>
            ...
            {/* Items Grid */}
            <div className="container" style={{ padding: '2.5rem 1.5rem', paddingBottom: cartCount > 0 ? '7rem' : '2.5rem' }}>
                <div style={{ marginBottom: '1.5rem' }}>
                    <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.5rem', color: 'var(--cream)', marginBottom: '0.25rem' }}>
