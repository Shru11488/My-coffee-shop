...
export default function ContactSection() {
    ...
    return (
        <section id="contact" style={{ background: 'var(--dark-roast)', padding: '6rem 0' }}>
            {/* Header */}
            ...
            <div className="container" style={{ padding: '0 1.5rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem', alignItems: 'start' }}>
                    ...
                    {/* Contact Info */}
                    <div>
                        <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.4rem', color: 'var(--cream)', marginBottom: '1.5rem' }}>
                            Get in Touch
                        </h3>
